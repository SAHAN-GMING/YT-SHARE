# -- Fb Id  - Asad Ahmed Sahan 
#-- GITHUB - https://github.com/SAHAN-GMING
...
print(f'''{B}{F}━━━━━━━━━━━━━⧪━━━━━━━━━━━━━{B}
|{Z}[+] YouTube    : {B}| SBD-X1N!
|{Z}[+] TeleGram  : {B} SBD-X1N!    |
|{Z}[+] Instagram  : {B}SBD-X1N! |
...
def YouTube():
    ...
    while True:
        ...
        try:           
            ...
            By = re.search(r'"ByiceExperimentId":"(.*?)"', req.text).group(1)
            ...
            Share(agent, proxy, cookies, video_id, clik, By, app, cli, vist, host)
            ...
            os.system('clear')
            print(f"""
{M}Tool : Free ~~ {G}BY : Sahan           
━━━━━━━━━━━━━━━━━━━━━━━━━━
{C}GOOD SHARE : {F}{good}
━━━━━━━━━━━━━━━━━━━━━━━━━━
{Z1}BAD Share : {X}{bad}
━━━━━━━━━━━━━━━━━━━━━━━━━━
{A}By : @SBD-X1N! ~~ {B}@SBD-X1N!
""")
            pass
        except:
            bad += 1
...
def Share(agent, proxy, cookies, video_id, clik, By, app, cli, vist, host):
    global good, bad
    hed1 = {
